...
{
    public partial class UserControlQLSach : UserControl
    {
        BLLSach bLLSach = new BLLSach();
        BLLXuLy bLLXuLy = new BLLXuLy();
        private string emailNhanVien;
        public UserControlQLSach(string emailNhanVien)
        {
        ...
        private void btnChoMuon_Click(object sender, EventArgs e)
        {
            ...
            frmChoMuonSach frm = new frmChoMuonSach(ma, emailNhanVien, this);
            frm.ShowDialog();
        }
        ...
        private void UserControlQLSach_Load(object sender, EventArgs e)
        {
            enabledControls(false);
            loadSachs();
            loadNhaXuatBans();
